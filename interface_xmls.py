...
class Har_interface:
    ...
    def write_xml(self, out_put='test.xml'):
        ...
        self.SL_BEC_cal()
        BEC = self.SL_BEC   # STRC.get_array('BEC') 
...
def model_maker(xmlf1, anh_file1, scmat1, xmlf2, anh_file2, scmat2, symmetric=False, har_file='int_harmoni.xml', Anhar_file='int_harmoni.xml',
